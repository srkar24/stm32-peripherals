...
// This function uses polling to achieve memory-to-memory (i.e Src to Dest) transfer
...
int main(void)
{
  ...
  MX_DMA_Init();
  /* USER CODE BEGIN 2 */
  // This method requires polling for transfer status using resume and suspend
